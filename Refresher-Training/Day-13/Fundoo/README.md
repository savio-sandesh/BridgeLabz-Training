...
- User registration with duplicate email validation and strict DTO model constraints
- Reset password flow (validates token and enforces strong password policy)
