...
namespace BusinessLayer.Interfaces
{
    public interface INoteService
    {
        ...
        Task<bool> SetReminderAsync(int noteId, int userId, string userEmail, SetReminderRequest request);
        Task<bool> RemoveReminderAsync(int noteId, int userId);
        Task<IEnumerable<Note>> GetNotesWithRemindersAsync(int userId);
    }
}