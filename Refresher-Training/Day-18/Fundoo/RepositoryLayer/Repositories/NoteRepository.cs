...
namespace RepositoryLayer.Repositories
{
    public class NoteRepository : INoteRepository
    {
        ...
        public async Task<bool> SetReminderAsync(int noteId, int userId, DateTime reminder)
        {
            var note = await _context.Notes.FirstOrDefaultAsync(n => n.NoteId == noteId && n.UserId == userId && !n.Trash);
            if (note == null) return false;
        ...
        {
            return await _context.Notes
                .Where(n => n.UserId == userId && !n.Trash && n.Reminder != null)
